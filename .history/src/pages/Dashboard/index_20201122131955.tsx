...
const Dashboard: React.FC = () => {
    ...
    const nextProducts = () => {
        const lastProductIndex2 = products.length -4;
        const resetProductIndex2 = productIndexProducts === lastProductIndex2;
        const index2 = resetProductIndex2 ? 0 : productIndexProducts + 1;
        setProductIndexProducts(index2);
