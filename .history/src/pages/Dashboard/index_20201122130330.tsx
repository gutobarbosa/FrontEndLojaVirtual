...
const Dashboard: React.FC = () => {
    ...
    let firstFourProducts = issues.slice(productIndex, productIndex + 4);

    const nextProduct = () => {
        const lastProductIndex = issues.length - 1;
  ...
  return (
    ...
    <ContainerProducts>
        ...
        <div className="arrowNext">
            <img src={arrownext} alt="arrownext" onClick={nextProduct} />
        </div>
